...
test_me() {
  ...
  >&2 echo It responds to our 'Q sslip.io IN SOA' with 'OK'
  printf "Q\tsslip.io\tIN\tSOA\n"
  read -r RESP

  if [ "${RESP}" == 'DATA	sslip.io	IN	SOA	300		admin.xip.test ns-1.xip.test 2016091100 300 300 300 300' ]; then
